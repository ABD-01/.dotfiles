...
local c_cc_snippets = {
	c = {
        s("main", {
            t('#include <stdio.h>'),
            t({ "", "", 'int main(int argc, char *argv[])', '{', '\t printf("' }),
            i(1, "Hello World!"),
            t('\\r\\n");'),
            t({ "", "\treturn " }),
            i(2, "69"),
        ...
        s("maincpp", {
            t('#include <iostream>'),
            t({ "", "", 'int main(int argc, char *argv[])', '{', '\tstd::cout << "' }),
            i(1, "Hello World"),
            t('" << std::endl;'),
            t({ "", "\treturn " }),
            i(2, "69"),
        ...
        s('#if', {
            t('#if '), i(1, '1'), t({'', ''}),
            i(0), t({'', '#endif /* '}), f(function(args) return args[1] end, 1), t(' */'),
        }),
    }
}

ls.add_snippets("c", c_cc_snippets.c)
ls.add_snippets("cpp", c_cc_snippets.c)
